...
cleos create account eosio dragonoption `cat /home/devcomp34/blockhain_scripts/my_blockchain/public_key.txt`
...
cleos set contract dragonoption /home/devcomp34/git/dragonoption/  --abi dragon_option.abi -p dragonoption@active
...
cleos push action dragonoption settknsett '["DRAGON","eosdragontkn",4,100000]' -p dragonoption@active
cleos push action dragonoption settknsett '["EOS","eosio.token",4,50]' -p dragonoption@active
cleos push action dragonoption settknsett '["EUSD","bitpietokens",8,50]' -p dragonoption@active
cleos push action dragonoption settknsett '["DICE","betdicetoken",4,10000]' -p dragonoption@active
cleos push action dragonoption settknsett '["CUSD","stablecarbon",2,50]' -p dragonoption@active
